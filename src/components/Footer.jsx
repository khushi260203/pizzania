...
const Footer = () => {
  return (
    <>
      <div className="w-full h-[340vh] md:h-[300vh] lg:h-[110vh]  flex flex-col  bg-[#fff] text-center">
        <div className="w-full flex flex-col items-center tracking-tighter">
          <h2 className="text-red-500 font-semibold text-lg md:text-xl">Our Location</h2>
          <h1 className="text-4xl md:text-7xl mt-3 font-semibold text-black">
            Find The Pizzania Near You
          </h1>
          <p className="text-black mt-5 text-md md:text-xl w-[50vw] tracking-tighter text-center">
        ...
        <div className="w-full mt-20 flex flex-col lg:flex-row justify-center items-center gap-30 pl-10 pr-10 tracking-tight">
          <div className="w-[15vw] flex flex-col items-center">
            <h1 className="text-3xl md:text-5xl font-semibold text-red-500">Rome</h1>
            <p className="text-center mt-5 text-md md:text-lg text-black">
              Via di S. Vincenzo, 12/34A, 00123 Roma RM, Italy. +39 123 456 7890
            </p>
          </div>
          <div className="w-[15vw] flex flex-col items-center">
            <h1 className="text-3xl md:text-5xl font-semibold text-red-500">Florence</h1>
            <p className="text-center mt-5 text-md md:text-lg text-black">
              Viale Belfiore, 50, 50144 Firenze FI, Italy. +39 123 456 7890
            </p>
          </div>
          <div className="w-[15vw] flex flex-col items-center">
            <h1 className="text-3xl md:text-5xl font-semibold text-red-500">Bologna</h1>
            <p className="text-center mt-5 text-md md:text-lg text-black">
              Via delle Lame, 55, 40122 Bologna BO, Italy. +39 123 456 7890
            </p>
          </div>
          <div className="w-[15vw] flex flex-col items-center">
            <h1 className="text-3xl md:text-5xl font-semibold text-red-500">Venice</h1>
            <p className="text-center mt-5 text-md md:text-lg text-black">
      ...
      <div className="w-full h-[50vh] md:h-[85vh] bg-[#F7F6F2] flex items-center justify-between text-black tracking-tighter px-5 md:px-10">
        <div className="w-[70vh] h-full flex flex-col justify-center">
          <h2 className="text-xl md:text-2xl lg:text-4xl text-black font-semibold">Free Delivery!</h2>
          <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold mt-5 whitespace-nowrap ">
          ...
          <div className="flex mt-10 gap-x-10">
            <button className="border border-red-500 text-red-500 text-sm md:text-xl px-2 md:px-6 md:py-2 rounded hover:bg-red-500 hover:text-white">
              Google Play
            </button>
            <button className="border border-red-500 text-red-500 px-2 md:px-6 md:py-2 rounded hover:bg-red-500 hover:text-white">
              App Store
            </button>
          </div>
        </div>
        <div className="flex w-[60vw] md:w-[30vw] px-5 ">
          <img
      ...
      <div className="w-full h-[160vh] md:h-[70vh] flex flex-wrap md:flex-row justify-between items-center bg-[#fff] gap-15 px-10 tracking-tighter ">
      ...
      <div className="w-full h-[10vh] flex justify-between items-center px-2 md:px-10  bg-[#ffffff]">
        <div className="text-[3vw] md:text-xl">Copyright &copy; 2025 The Pizzania.</div>
        <div className="text-[3vw] md:text-xl">Powered by The Pizzania</div>
      </div>
    </>
  );
};
